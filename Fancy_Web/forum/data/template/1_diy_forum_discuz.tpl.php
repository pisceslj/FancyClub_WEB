...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameRL3F7f" class="frame move-span cl frame-1"><div id="frameRL3F7f_left" class="column frame-1-c"><div id="frameRL3F7f_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
<?php } ?>
